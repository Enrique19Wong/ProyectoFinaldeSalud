            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form Method="POST" action="./eliminar.htm" >
                        ...
                        <input class="form-control" type="text" name="Nombre" readonly="readonly" value="${dato.Direccion}"/>
                        <label  class="form-label">Telefono</label>
                        <input class="form-control" type="text" name="Nombre" readonly="readonly" value="${dato.Telefono}"/>
                        <label  class="form-label">Correo</label>
                        <input class="form-control" type="text" name="Nombre" readonly="readonly" value="${dato.Correo}"/>
                        </c:forEach>
