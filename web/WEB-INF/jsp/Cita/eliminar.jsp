            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form Method="POST" action="./eliminar.htm" >
                        ...
                        <input class="form-control" type="text" name="IDDoctor" readonly="readonly" value="${dato.IDCita}" />
                        <label  class="form-label">Doctor</label>
                        <Select class="form-select" name="IDEspecialidad" readonly="readonly" value="${dato.IDDoctor}" >
                        ...
                        <Select class="form-select" name="IDEspecialidad" readonly="readonly" value="${dato.IDPaciente}" >
                        ...
                        <input class="form-control" type="text" name="Telefono" readonly="readonly" value="${dato.Fecha}"/>
                        <label  class="form-label">Diagnostico</label>
                        <input class="form-control" type="text" name="Telefono" readonly="readonly" value="${dato.Diagnostico}"/>
                        <label  class="form-label">Tratamiento</label>
                        <input class="form-control" type="text" name="Telefono" readonly="readonly" value="${dato.Tratamiento}"/>
                        <label  class="form-label">Observaciones</label>
                        <input class="form-control" type="text" name="Telefono" readonly="readonly" value="${dato.Observaciones}"/>
                        <br>
                        </c:forEach>
